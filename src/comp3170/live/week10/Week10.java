...
public class Week10 implements IWindowListener{

	private static final File COMMON_DIR = new File("src/comp3170/live/common/shaders");
	private static final File SHADER_DIR = new File("src/comp3170/live/week10/shaders");
	...
	public Week10() throws OpenGLException {
