...
public class Week11 implements IWindowListener{
	...
	private static final File SHADER_DIR = new File("src/comp3170/live/week11/shaders");
	private static final File TEXTURE_DIR = new File("src/comp3170/live/week11/textures");
